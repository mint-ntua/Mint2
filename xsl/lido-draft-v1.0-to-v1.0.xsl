                  ...
                  <lido:objectWorkTypeWrap>
                    <xsl:for-each select="lido:objectWorkType">
                      <lido:objectWorkType>
                        ...
                        <xsl:for-each select="@lido:sortorder">
                          <xsl:if test="position() = 1">
                  ...
                  <lido:inscriptionsWrap>
                    <xsl:for-each select="lido:inscriptions">
                      <lido:inscriptions>
                        ...
                        <xsl:for-each select="lido:inscriptionDescription">
                          <lido:inscriptionDescription>
                            ...
                            <xsl:for-each select="lido:descriptiveNoteID">
                          ...
                          <lido:objectMeasurements>
                            <xsl:for-each select="lido:measurementsSet">
                              <lido:measurementsSet>
                                ...
                                <xsl:for-each select="lido:measurementType">
              ...
              <lido:objectRelationWrap>
                ...
                <xsl:for-each select="lido:relatedWorksWrap">
                  <lido:relatedWorksWrap>
                    <xsl:for-each select="lido:relatedWorkSet">
                      <lido:relatedWorkSet>
                        <xsl:for-each select="@lido:sortorder">
                          <xsl:if test="position() = 1">
                            <xsl:attribute name="lido:sortorder">
              ...
              <lido:resourceWrap>
                <xsl:for-each select="lido:resourceSet">
                  <lido:resourceSet>
                        ...
                        <xsl:for-each select="lido:linkResource">
                          <xsl:if test="position() = 1">
                            <lido:linkResource>
                              ...
                              <xsl:for-each select="@lido:codecResource">
                                <xsl:if test="position() = 1">
                                  <xsl:attribute name="lido:codecResource">
                                    <xsl:value-of select="."/>
                                  </xsl:attribute>
                                </xsl:if>
                              </xsl:for-each>
                    ...
                    <xsl:for-each select="lido:resourcePerspective">
