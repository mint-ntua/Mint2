...
aggregationCHO = aggregation.getChild("edm:aggregatedCHO");
aggregationCHO.setFixed(true);
aggregatedCHOResource = aggregationCHO.getHandlerForName("@resource");
mappingHandler.addBookmark("- Aggregated Source Resource", aggregatedCHOResource);
...
provider = aggregation.getChild("edm:provider");
mappingHandler.addBookmark("- Provider", provider);
