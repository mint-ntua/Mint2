...
for(JSONMappingHandler handler: handlers) {
    ...
    if(rdfType != null){
		...
		resource.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.0/Document", "Document");
		resource.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.0/File", "File");
		...
		resource.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.0/Manuscript", "Manuscript");
		resource.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.0/Page", "Page");
		resource.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.0/Photo", "Photo");
		resource.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.0/Work", "Work");
		...
		resource.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.0/Paragraph", "Paragraph");
		resource.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.0/Publication", "Publication");
...
for(JSONMappingHandler handler: handlers) {
    rdfType = handler.getChild("rdf:type");
    JSONMappingHandler resource = rdfType.getHandlerForName("@resource");
	resource.addEnumeration("http://onto.dm2e.eu/schemas/dm2e/1.0/Archive", "Archive");
