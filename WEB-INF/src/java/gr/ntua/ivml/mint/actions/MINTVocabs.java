...
public class MINTVocabs extends GeneralAction {
	...
	public String topConcepts() {
		...
		JSONArray concepts = JSONUtils.toJSON(skos.getTopConcepts(VOCABULARY_PROPERTY + "iso_639_1"));
	...
	public String concepts() {
		...
		JSONArray concepts = JSONUtils.toJSON(skos.getConcepts(VOCABULARY_PROPERTY + "iso_639_1"));
