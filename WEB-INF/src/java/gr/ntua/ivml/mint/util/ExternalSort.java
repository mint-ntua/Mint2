...
public class ExternalSort {
	...
	public ExternalSort( long memoryUsage ) {
		blocksize = memoryUsage;
	}
	 ...
	 */
	public  List<File> sortInBatch(Reader inFile, Writer outFile, Comparator<String> cmp) throws IOException {
	...
	public  void sortAndSave(List<String> tmplist, Comparator<String> cmp, Writer outFile ) throws IOException  {
	 ...
	 */
	public  int mergeSortedFiles(List<File> files, Writer outputWriter, final Comparator<String> cmp) throws IOException {
	 ...
	 * @throws IOException
	 */
	public void sort( File in, File out, Comparator<String> c ) throws IOException {
	 ...
	 * @throws IOException
	 */
	public  void sort( Reader in, Writer out, Comparator<String> c ) throws IOException {
	...
	public static void main( String[] args ) {
		...
		try {
			ExternalSort es= new ExternalSort( 10000000l );
			es.sort( in, out, c );
		} catch( Exception e ) {
			e.printStackTrace();
		}
