...
public class TreeGenerationParser {
	...
	public String parseUpload( Dataset ds ) {
		return this.parseUpload(ds, true);		
	}
	
	public String parseUpload( Dataset ds, boolean includeDiv ) {
		this.treeId = "1";
		this.counter = 0;
		StringBuffer res = new StringBuffer();
		if(includeDiv) res.append( "<div id=\"treemenu_" + treeId +"\">" );

		traverseXpathHolder( ds.getRootHolder().getChildren(), res );
