...
//		this.dataUpload = DB.getDataUploadDAO().findById(Long.parseLong(this.uploadid), false);
		...
		XpathHolder rootXpath = this.dataUpload.getRootHolder();
		if(rootXpath != null) {
...
//		this.dataUpload = DB.getDataUploadDAO().findById(Long.parseLong(this.uploadid), false);
		...
		if(this.dataUpload.getItemRootXpath()!=null)	
			rootXpath=this.dataUpload.getItemRootXpath().getParent();
		if(rootXpath==null){
			rootXpath=this.dataUpload.getItemRootXpath();
		}
		XpathHolder itemXpath = this.dataUpload.getItemRootXpath();
		XpathHolder rXpath=this.dataUpload.getRootHolder();
