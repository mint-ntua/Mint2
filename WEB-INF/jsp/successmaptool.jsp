...
$(function() {
   ...
   var data2={kConnector:'html.page', url:'DoMapping.action?mapid=<%=request.getParameter("selectedMapping")%>&uploadId=<%=request.getParameter("uploadId")%>', kTitle:'Mapping Tool' };
